<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
	<?php include("administradores_lateral.php") ?>
</div>
<div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
	...
	<div class="alert alert-success text-center banner_admin">
		...
		<p>Aquí podrás agregar, modificar y/o eliminar los datos de los administradores del sitio</p>
	</div>
	<?php include("administradores_contenido.php") ?>
</div>